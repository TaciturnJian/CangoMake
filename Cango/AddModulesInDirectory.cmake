...
macro(Cango_AddModulesInDirectory_GuardArgs_Directory)
	if ("${ARG_DIRECTORY}" STREQUAL "")
		message(FATAL_ERROR "${PROJECT_NAME}> missing parameter: DIRECTORY")
	endif()
endmacro()
...
macro(Cango_AddModulesInDirectory_Process)
	...
	Cango_AddModulesInDirectory_Log("${PROJECT_NAME}> adding ${modules_count} submodule(${modules}) at ${module_dir}")
